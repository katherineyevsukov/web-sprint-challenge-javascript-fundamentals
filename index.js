...
function summation(number) {
  ...
  for(let i = 0; i <number; i++){
    count += 1
    array.push(count)
  } const finalSum = array.reduce(function(total, value){
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const lowerCaseAnimals = array.map(function(animal){
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowestPopAnimals = array.filter(function(animal){
      return animal.population < 5;
    }); return lowestPopAnimals;
  }
  ...
  */
  ...
  function USApop(array){
   const totalPop = array.reduce(function(acc, animal){
...
function add(a, b){
  ...
  console.log('step 2a:', consume(4, 5, add));
// 🦁🦁🦁 Use multiply to return the product of two numbers 🦁🦁🦁
  
function multiply(a, b){
   return a * b
  }
 console.log('step 2b:',consume(4, 5, multiply));
...
function greeting(a, b){
  ...
  console.log('step 2c:', consume('Marty', 'McFly', greeting));
...
// console.log(cuboid.surfaceArea()); // 130
 console.log('topic 3, test 1:', cuboid.volume());
 console.log('topic 3, test 2:', cuboid.surfaceArea());
